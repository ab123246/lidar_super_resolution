...
class PointCloudProcessor:
    ...
    def test_comparison(self):
        ...
        origImages = np.load(os.path.join(home_dir, 'Documents', project_name, 'campus_image.npy')) # 
        # predicted image: n x rows x cols x 2
        predImages = np.load(os.path.join(home_dir, 'Documents', project_name, 'campus_image-from-16-to-64_prediction.npy')) * normalize_ratio # 
